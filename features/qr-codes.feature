...
Функционал: Создание и просмотр QR-Кодов
 ...
 Сценарий: Пользователь может скачать сгенерированый QR код
  Допустим я захожу на /barcodes
  Тогда я должен увидеть QR код:
    | type | text_code |
  Когда я кликну "Cкачать изображение"
  Тогда я должен загрузить QR код

 @javascript
 Сценарий: Пользователь может удалить сгенерированый QR код
   # Как нажать "ОК" в окне предупреждения?
   # Допустим я захожу на /barcodes
   # Тогда я должен увидеть QR код:
   #   | type | text_code |
   # Когда я кликну "Удалить"
   # Тогда я не должен видеть QR код:
   #   | type | text_code |
