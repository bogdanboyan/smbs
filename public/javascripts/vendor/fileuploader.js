...
qq.FileUploaderBasic = function(o){
    this._options = {
        ...
        messages: {
          ...
          typeError: "Файл '{file}' не является изображением. Изображения это файлы с расширением {extensions}.",
          sizeError: "Файл '{file}' превышает разрешенный размер {sizeLimit}. Попробуйте уменьшить размер файла.",
          emptyError: "Вы пытаетесь загрузить пустой файл. Возможно вы ошиблись.",
          minSizeError: "Файл '{file}' слишком маленький. Минимальный размер загружаемого файла - это {minSizeLimit}.",
          onLeave: "Файлы загружаются, если вы сейчас перейдете на другую страницу загрузка будет отменена."
        },
