...
describe ClicksAgregator do
  ...
  describe 'should test summarize_clicks_for' do
    ...
    it 'should build summarized_click' do
      ...
      s_clicks = ClicksAgregator.summarize_clicks_for(@short_url.id, @short_url.created_at.to_date)
      ...
      lambda { ClicksAgregator.summarize_clicks_for(@short_url.id, @short_url.created_at.to_date)}.should raise_error
    end
  end
end